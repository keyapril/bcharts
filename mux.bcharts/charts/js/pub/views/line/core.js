KISSY.add('mux.bcharts/charts/js/pub/views/line/core',function(S,Base,Node,Global,DataSection,SVGElement,Vertical,Horizontal,Back,GlobalInduce,EventType,Graphs){
	var $ = Node.all
