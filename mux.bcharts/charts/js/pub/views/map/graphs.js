KISSY.add('mux.bcharts/charts/js/pub/views/map/graphs',function(S,Base,node,Global,Move,SVGElement,SVGRenderer,SVGGraphics,EventType,Sign){
	...
	S.extend(Graphs,Base,{
		...
		_getPath:function($name){
			var self = this
			return 'mux.bcharts/charts/js/pub/views/map/maps/' + $name + '/' + 'main'
		}
	});
