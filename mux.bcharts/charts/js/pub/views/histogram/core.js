KISSY.add('mux.bcharts/charts/js/pub/views/histogram/core',function(S,Base,Node,Global,DataSection,SVGElement,Vertical,Horizontal,Back,GlobalInduce,EventType,Graphs){
	var $ = Node.all
